...
export interface IUser extends Document {
  ...
  telegramUsername?: string | null; // username пользователя
  hasTelegramPremium?: boolean | null; // наличие Telegram Premium
...
const UserSchema = new Schema<IUser>(
  {
    ...
    hasTelegramPremium: { type: Boolean, default: null },
